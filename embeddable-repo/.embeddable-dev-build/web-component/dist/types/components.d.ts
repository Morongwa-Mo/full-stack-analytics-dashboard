...
declare namespace LocalJSX {
    ...
    interface EmbeddableComponentAttributes {
        "componentName": string;
        "props": string;
        "clientContext": string;
        "theme": string;
    ...
    interface IntrinsicElements {
        "embeddable-component": Omit<EmbeddableComponent, keyof EmbeddableComponentAttributes> & { [K in keyof EmbeddableComponent & keyof EmbeddableComponentAttributes]?: EmbeddableComponent[K] } & { [K in keyof EmbeddableComponent & keyof EmbeddableComponentAttributes as `attr:${K}`]?: EmbeddableComponentAttributes[K] } & { [K in keyof EmbeddableComponent & keyof EmbeddableComponentAttributes as `prop:${K}`]?: EmbeddableComponent[K] };
    }
}
...
declare module "@stencil/core" {
    export namespace JSX {
        interface IntrinsicElements {
            "embeddable-component": LocalJSX.IntrinsicElements["embeddable-component"] & JSXBase.HTMLAttributes<HTMLEmbeddableComponentElement>;
        }
    }
}
