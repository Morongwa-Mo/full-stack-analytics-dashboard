...
var s = { exports: {} }, p = s.exports, _;
function l() {
  return _ || (_ = 1, (function(i, a) {
    (function(n, e) {
      i.exports = e(rt());
    })(p, (function(n) {
      function e(t) {
      ...
      var r = e(n), o = { name: "fy", weekdays: "snein_moandei_tiisdei_woansdei_tongersdei_freed_sneon".split("_"), months: "jannewaris_febrewaris_maart_april_maaie_juny_july_augustus_septimber_oktober_novimber_desimber".split("_"), monthsShort: "jan._feb._mrt._apr._mai_jun._jul._aug._sep._okt._nov._des.".split("_"), weekStart: 1, weekdaysShort: "si._mo._ti._wo._to._fr._so.".split("_"), weekdaysMin: "Si_Mo_Ti_Wo_To_Fr_So".split("_"), ordinal: function(t) {
        return t;
...
var u = l();
const y = /* @__PURE__ */ by(u), Y = /* @__PURE__ */ d({
  __proto__: null,
  default: y
}, [u]);

export { Y as f };
//# sourceMappingURL=fy-B-8rsaFe-CWFmF75k-BSmYxyKe.js.map
//# sourceMappingURL=fy-B-8rsaFe-CWFmF75k-BSmYxyKe.js.map
