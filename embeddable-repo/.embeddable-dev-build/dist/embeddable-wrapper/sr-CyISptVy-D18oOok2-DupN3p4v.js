    ...
    if (typeof t != "string" && !Array.isArray(t)) {
      for (const a in t)
        if (a !== "default" && !(a in i)) {
          ...
          r && Object.defineProperty(i, a, r.get ? r : {
            enumerable: true,
            get: () => t[a]
          });
        }
...
var m = { exports: {} }, j = m.exports, c;
function y() {
  return c || (c = 1, (function(i, s) {
    (function(o, t) {
      i.exports = t(rt());
    })(j, (function(o) {
      function t(e) {
      ...
      var a = t(o), r = { words: { m: ["jedan minut", "jednog minuta"], mm: ["%d minut", "%d minuta", "%d minuta"], h: ["jedan sat", "jednog sata"], hh: ["%d sat", "%d sata", "%d sati"], d: ["jedan dan", "jednog dana"], dd: ["%d dan", "%d dana", "%d dana"], M: ["jedan mesec", "jednog meseca"], MM: ["%d mesec", "%d meseca", "%d meseci"], y: ["jednu godinu", "jedne godine"], yy: ["%d godinu", "%d godine", "%d godina"] }, correctGrammarCase: function(e, n) {
        return e % 10 >= 1 && e % 10 <= 4 && (e % 100 < 10 || e % 100 >= 20) ? e % 10 == 1 ? n[0] : n[1] : n[2];
      }, relativeTimeFormatter: function(e, n, d, f) {
        var u = r.words[d];
        if (d.length === 1) return d === "y" && n ? "jedna godina" : f || n ? u[0] : u[1];
        var l = r.correctGrammarCase(e, u);
        return d === "yy" && n && l === "%d godinu" ? e + " godina" : l.replace("%d", e);
...
var p = y();
const Y = /* @__PURE__ */ by(p), k = /* @__PURE__ */ g({
  __proto__: null,
  default: Y
}, [p]);

export { k as s };
//# sourceMappingURL=sr-CyISptVy-D18oOok2-DupN3p4v.js.map
//# sourceMappingURL=sr-CyISptVy-D18oOok2-DupN3p4v.js.map
